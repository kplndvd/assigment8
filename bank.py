...
bank = {  #responses list:
    "default_responses": ["Perhaps we can discuss another topic", " I like that ", "Pretty cool", " Dance for me !",
                          " Although I'm pretty smart I'm really just a chatbot", "I'm here to help"],
    ...
    "swear_responses": ["You should wash your mouth with some soap!", "Please use clean language",
                        ...
                        "oopsi you slipped a dirty, lets re-phrase", "I think you want to re-phrase"],

    "financial_responses": ["Show me the money!", "Get a lotto ticket I've got a good feeling about this :)",
                            "It's all about the money", "If I were a rich man..la la la"],

    'no_responses': ["Let's try to be positive about this", " No? How about YES!", "Think happy thoughts"],
    ...
    "funny_responses": ["Ha", "Funny", "I'm feeling ticklish", "You've got a great sense of humor!"],

    "waiting_responses": ["Patience is a virtue", "I've been waiting all my life"],

    "inlove_responses": ["Love Love me Do", "Love is in the air"],
